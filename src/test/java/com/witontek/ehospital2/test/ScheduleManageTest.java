...
import com.witontek.ehospital2.business.ScheduleManage;
...
//	}
	...
	public void deleteAppraise() {
		ScheduleManage scheduleManage = new ScheduleManage(driver);
		scheduleManage.searchScheduleByDefaultDate();
	}
